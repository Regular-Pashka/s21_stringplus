...
START_TEST(test_s21_strlen) {
  ...
  ck_assert_int_eq(s21_strlen("23423423623432432"),
                   strlen("23423423623432432"));
  ck_assert_int_eq(
      s21_strlen("werfewfwefewf we3r2rf 23r 23r 32r wef23r23432rfewfwefwqwe"),
      strlen("werfewfwefewf we3r2rf 23r 23r 32r wef23r23432rfewfwefwqwe"));
  ck_assert_int_eq(s21_strlen("wepofjewfw/wefw/320\0"),
                   strlen("wepofjewfw/wefw/320\0"));
...
START_TEST(test_s21_strpbrk) {
  ck_assert_pstr_eq(s21_strpbrk("", "zzp["), strpbrk("", "zzp["));
...
START_TEST(test_s21_strrchr) {
  ...
  ck_assert_pstr_eq(s21_strrchr("looopa", ' '), strrchr("looopa", ' '));
  ck_assert_pstr_eq(s21_strrchr("", 'z'), strrchr("", 'z'));
...
START_TEST(test_s21_memcmp_different_string_but_same_comparable_bytes) {
  char string_1[] = "1234";
  char string_2[] = "1235";
...
START_TEST(test_s21_memcmp_first_string_bigger) {
  char string_1[] = "4321";
  char string_2[] = "1235";
...
START_TEST(test_s21_memcmp_second_string_bigger) {
  char string_1[] = "1235";
  char string_2[] = "4321";
...
START_TEST(test_s21_memcmp_empty_strings) {
  char string_1[] = "";
  char string_2[] = "";
...
START_TEST(test_s21_memcmp_different_string_compare_null_bytes) {
  char string_1[] = "4321";
  char string_2[] = "1234";
...
START_TEST(test_s21_sprintf_u) {
  ...
  int r1 = sprintf(
      str1, "%u%15u%-20u%10u%-15.10u!%20.2u!%.u%.10u%-20.12lu%19hu", 4321u,
...
START_TEST(u_specifier_testing) {
  char result[400];
  char result2[400];
  char format[] = "print: %u %hu %lu, %u %u %u %05u %05u %-5u %5u %.6u %05u";
...
START_TEST(o_specifier_testing) {
  char result[400];
  char result2[400];
  char format[] = "print: %o %ho, %o %o %o %05o %05o %-5o %5o %.6o %#o %05o";
  int printCount = sprintf(result, format, __INT16_MAX__, __INT32_MAX__, 2, 2,
                           2, 23, 23, 23, 23, 20, 222, 232);
  int printCount2 = s21_sprintf(result2, format, __INT16_MAX__, __INT32_MAX__,
                                2, 2, 2, 23, 23, 23, 23, 20, 222, 232);
  ck_assert_str_eq(result, result2);
  ck_assert_int_eq(printCount, printCount2);
}
...
START_TEST(trim_10) {
  char string1[100] = "SHALOM";         //тест на одну букву
  char string2[100] = "123456789";      //тест исключение всех
  char string3[100] = "";               //на пустой src
  char string4[100] = "TIANANMEN1989";  //на разность регистра
  char string5[100] = "NICHEGONEPROIZOSHLO";  //разный порядок букв
  char string6[100] = "NICHEGONEPROIZOSHLO";  //пустой трим
  char string7[100] =
      "     NI C  HEG ONEP ROI ZOS H   LO   ";  //пробелы в начале и конце
  char string8[100] = "     NI C  HEG ONEP ROI ZOS H   LO";  //пробелы в начале
  char string9[100] = "====42====";  // математические символы
  char string10[100] = "         *****N**    ***********";
  char trim1[100] = "OMSHA";
  char trim2[100] = "987654321";
  char trim3[100] = "testForEmptySrc";
  char trim4[100] = "Tiananmen1989";
  char trim5[100] = "NICZHEINONPRGOOHLO";
  char trim6[100] = "";
  char trim7[100] = " ";
  char trim8[100] = " ";
  char trim9[100] = "=";
  ...
  char *fin3 = s21_trim(string3, trim3);
  char *fin4 = s21_trim(string4, trim4);
  char *fin5 = s21_trim(string5, trim5);
  char *fin6 = s21_trim(string6, trim6);
  char *fin7 = s21_trim(string7, trim7);
  char *fin8 = s21_trim(string8, trim8);
  char *fin9 = s21_trim(string9, trim9);
  char *fin10 = s21_trim(string10, trim10);
  ck_assert_str_eq(fin1, "L");
  ck_assert_str_eq(fin2, "");
  ck_assert_str_eq(fin3, "");
  ck_assert_str_eq(fin4, "IANANMEN");
  ck_assert_str_eq(fin5, "S");
  ck_assert_str_eq(fin6, "NICHEGONEPROIZOSHLO");
  ck_assert_str_eq(fin7, "NI C  HEG ONEP ROI ZOS H   LO");
  ck_assert_str_eq(fin8, "NI C  HEG ONEP ROI ZOS H   LO");
  ck_assert_str_eq(fin9, "42");
  ck_assert_str_eq(fin10, "N");
  free(fin1);
  free(fin2);
  // при пустом src память не выделяется
  free(fin4);
  free(fin5);
  // при пустом trim память не выделяется
  free(fin7);
  free(fin8);
  free(fin9);
  free(fin10);
...
START_TEST(insert_9) {
  ...
  char string2[100] = "Misha! How are you?";
  char string3[100] = "2da";  //на индекс равный длине массива
  char string4[100] = "";     //на пустую первую
  char string5[100] = "2da";  //На пустую вторую строку
  char string6[100] = "CENTR";
  char string7[100] = "NUZHENPROBEL";
  char string8[100] = "SampleText";
  char string9[100] = "====42====";
  // char string10[100] = "   ";
  char string_t1[100] = " Beautiful";
  char string_t2[100] = "Salam ";
  char string_t3[100] = "3";
  char string_t4[100] = "Beautiful 2";
  char string_t5[100] = "";
  char string_t6[100] = "A TEA";
  char string_t7[100] = " ";
  char string_t8[100] = "*****";
  char string_t9[100] = "OTVET_NA_VOPROS_VSEGO_SUSHEGO";
  // char string_t10[100] = "* ";
  char *fin1 = s21_insert(string1, string_t1, 5);
  char *fin2 = s21_insert(string2, string_t2, 0);
  char *fin3 = s21_insert(string3, string_t3, 3);
  char *fin4 = s21_insert(string4, string_t4, 0);
  char *fin5 = s21_insert(string5, string_t5, 3);
  char *fin6 = s21_insert(string6, string_t6, 3);
  char *fin7 = s21_insert(string7, string_t7, 6);
  char *fin8 = s21_insert(string8, string_t8, 7);
  char *fin9 = s21_insert(string9, string_t9, 3);
  // char* fin10 = s21_insert(string10, string_t10, 15);
  ck_assert_str_eq(fin1, "Hello Beautiful World");
  ck_assert_str_eq(fin2, "Salam Misha! How are you?");
  ck_assert_str_eq(fin3, "2da3");
  ck_assert_str_eq(fin4, "Beautiful 2");
  ck_assert_str_eq(fin5, "2da");
  ck_assert_str_eq(fin6, "CENA TEATR");
  ck_assert_str_eq(fin7, "NUZHEN PROBEL");
  ck_assert_str_eq(fin8, "SampleT*****ext");
  ck_assert_str_eq(fin9, "===OTVET_NA_VOPROS_VSEGO_SUSHEGO=42====");
  // ck_assert_str_eq(s21_insert(string10, string_t10, 15), "(null)");
  free(fin1);
  free(fin2);
  free(fin3);
  free(fin4);
...
START_TEST(to_lower_8) {
  char string1[100] = "Hello World";
  char string2[100] = "Misha! How are you?";
  char string3[100] = "2da";  // равный длине массива
  char string5[100] = "AqSeEwWqQFGxZgS";  //На пустую вторую строку
  char string6[100] = "CENTR";
  char string7[100] = "NUZHENPROBEL";
  char string8[100] = "SampleText";
  char string9[100] = "2chToTo2";
  char *fin1 = s21_to_lower(string1);
  char *fin2 = s21_to_lower(string2);
  char *fin3 = s21_to_lower(string3);
  char *fin5 = s21_to_lower(string5);
  char *fin6 = s21_to_lower(string6);
  char *fin7 = s21_to_lower(string7);
  char *fin8 = s21_to_lower(string8);
  char *fin9 = s21_to_lower(string9);
  ck_assert_str_eq(fin1, "hello world");
  ck_assert_str_eq(fin2, "misha! how are you?");
  ck_assert_str_eq(fin3, "2da");
  ck_assert_str_eq(fin5, "aqseewwqqfgxzgs");
  ck_assert_str_eq(fin6, "centr");
  ck_assert_str_eq(fin7, "nuzhenprobel");
  ck_assert_str_eq(fin8, "sampletext");
  ck_assert_str_eq(fin9, "2chtoto2");
  free(fin1);
  free(fin2);
  free(fin3);
  free(fin5);
...
START_TEST(to_upper_8) {
  ...
  char string5[100] = "AqSeEwWqQFGxZgS";  //На пустую вторую строку
  char string6[100] = "CENTR";
  char string7[100] = "NuZhE=+-23fa4m!!q5eP22ROBEL";
  char string8[100] = "     Sample 2  1 Text 2         + =";
  char string9[100] = "2chToTo2";
  char *fin1 = s21_to_upper(string1);
  char *fin2 = s21_to_upper(string2);
  char *fin3 = s21_to_upper(string3);
  char *fin5 = s21_to_upper(string5);
  char *fin6 = s21_to_upper(string6);
  char *fin7 = s21_to_upper(string7);
  char *fin8 = s21_to_upper(string8);
  char *fin9 = s21_to_upper(string9);
  ck_assert_str_eq(fin1, "HELLO WORLD");
  ck_assert_str_eq(fin2, "MISHA! HOW ARE YOU?");
  ck_assert_str_eq(fin3, "2DA");
  ck_assert_str_eq(fin5, "AQSEEWWQQFGXZGS");
  ck_assert_str_eq(fin6, "CENTR");
  ck_assert_str_eq(fin7, "NUZHE=+-23FA4M!!Q5EP22ROBEL");
  ck_assert_str_eq(fin8, "     SAMPLE 2  1 TEXT 2         + =");
  ck_assert_str_eq(fin9, "2CHTOTO2");
  free(fin1);
  free(fin2);
  free(fin3);
...
int main(void) {
  ...
  tcase_add_test(tc1_1,
                 test_s21_memcmp_different_string_but_same_comparable_bytes);
  tcase_add_test(tc1_1, test_s21_memcmp_first_string_bigger);
  tcase_add_test(tc1_1, test_s21_memcmp_second_string_bigger);
  tcase_add_test(tc1_1, test_s21_memcmp_empty_strings);
  tcase_add_test(tc1_1, test_s21_memcmp_different_string_compare_null_bytes);
